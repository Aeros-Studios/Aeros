# Aeros [![GitHub Workflow Status](https://github.com/Wind-Development/Aeros/actions/workflows/windspigot-build-and-upload.yml/badge.svg)](https://nightly.link/Wind-Development/Aeros/workflows/windspigot-build-and-upload/master/Aeros-server.zip) [![Codacy Badge](https://app.codacy.com/project/badge/Grade/3c5ee8d2ef324d23ab085d89139ea0e7)](https://www.codacy.com/gh/Wind-Development/Aeros/dashboard?utm_source=github.com&utm_medium=referral&utm_content=Wind-Development/Aeros&utm_campaign=Badge_Grade) [![Discord](https://img.shields.io/discord/949530782261714974?label=discord)](https://discord.gg/hqbJvQZpV2)

##### Aeros is a 1.8.8 Minecraft server software focused on improving overall server performance and pvp mechanics based on a **[fork of NachoSpigot](https://github.com/Argarian-Network/NachoSpigot/tree/async-entity-tracker)**.

**Aeros supports Java 8 to Java 18!**

## Downloads

See the **[releases](https://github.com/Wind-Development/Aeros/releases)** tab for the latest release.

## FAQ

#### What combat mechanics are improved on?

Aeros makes potion speed and hit delay configurable. We also have NachoSpigot's configurable knockback.

#### How do I customize knockback?

Knockback can be configured in-game with the /kb command. See the **[wiki](https://github.com/Wind-Development/Aeros/wiki/Knockback-Configuration)** for information on settings.

#### What does Aeros do to improve overall performance?

Aeros moves heavy work off of the main server thread and splits up the server load.

#### What other modifications does Aeros have?
...
```
[Aeros-0001] Thread affinity
[Aeros-0002] Aeros config
[Aeros-0003] Mob AI toggle command
[Aeros-0004] Parallel world ticking
[Aeros-0005] Disable mob spawning if tps is not stable
[Aeros-0006] Remove FastMath
[Aeros-0007] Player ping command
[Aeros-0008] Make NachoSpigot's async TNT configurable
[Aeros-0009] Configurable entity hit delay
[Aeros-0010] Configurable potion speeds
[Aeros-0011] Make console display of player ips toggleable
[Aeros-0012] Re-implement Spigot's max tick time for certain configurable entities
[Aeros-0013] More configuration for knockback
[Aeros-0014] Async entity path searching
[Aeros-0015] Configurable explosion animations and sound
[Aeros-0016] Configurable weather changes
[Aeros-0017] Configurable fishing rod speed multiplier
