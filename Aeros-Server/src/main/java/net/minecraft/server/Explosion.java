...
public class Explosion {
			...
			if (!entity.aW()) {
				if (!entity.dead) {
					...
					if (distanceSquared <= 64.0D && distanceSquared != 0.0D) {
						...
						// Aeros start - toggleable async explosions
	...
	private void processEntityKnockback(Entity entity, double d7, double finalD, double finalD1, double finalD11,
			float f3, double d12) {
	...
	public void a(boolean flag) {
		...
		// Aeros start - configurable explosion sounds
		if (AerosConfig.explosionSounds) {
		...
		// Aeros start - configurable explosion animations
		if (AerosConfig.explosionAnimation) {
		...
		if (this.b) {
			...
			if (explode != null) {
				...
				if (AerosConfig.fireEntityExplodeEvent) {
