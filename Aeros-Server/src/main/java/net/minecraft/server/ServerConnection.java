...
import dev.aeros.protocol.MinecraftPipeline;
...
public class ServerConnection {
	...
	public void a(InetAddress ip, int port) throws IOException {
		synchronized (this.getListeningChannels()) {
			...
			LOGGER.info("Aeros: Using " + Natives.compress.getLoadedVariant() + " compression from Velocity.");
			LOGGER.info("Aeros: Using " + Natives.cipher.getLoadedVariant() + " cipher from Velocity.");
			// Paper end
