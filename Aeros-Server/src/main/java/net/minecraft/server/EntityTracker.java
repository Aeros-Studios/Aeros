...
import dev.aeros.commons.ConcurrentIntHashMap;
...
public class EntityTracker {
	...
	public IntHashMap<EntityTrackerEntry> trackedEntities = new ConcurrentIntHashMap<>(); // Aeros

	private volatile int noTrackDistance = 0; // Aeros - volatile
	...
	// IonSpigot start
	protected EntityTrackerEntry createTracker(Entity entity, int i, int j, boolean flag) { // Aeros - protected
		if (entity.isCannoningEntity && AerosConfig.useFasterCannonTracker) {
