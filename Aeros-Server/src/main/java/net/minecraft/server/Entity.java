...
public abstract class Entity implements ICommandListener {
	...
	public boolean invulnerable; // Aeros - private -> public
	...
	public double distanceSqrdAccurate(Entity entity) {
		...
		if (AerosConfig.improvedHitDetection && entity instanceof EntityPlayer && this instanceof EntityPlayer) {
			...
			if (entityPlayer.playerConnection.getClass().equals(PlayerConnection.class)
				...
				loc = Aeros.getInstance().getLagCompensator().getHistoryLocation(entityPlayer.getBukkitEntity(),
						player.ping);
			} else {
