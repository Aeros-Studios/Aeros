...
public abstract class MobSpawnerAbstract {
	...
	public MobSpawnerAbstract() {
		// Aeros start - configurable spawner settings
		this.spawnDelay = AerosConfig.spawnersInitialSpawnDelay;
		this.minSpawnDelay = AerosConfig.spawnersMinSpawnDelay;
		this.maxSpawnDelay = AerosConfig.spawnersMaxSpawnDelay;
		this.spawnCount = AerosConfig.spawnersSpawnCount;
		this.spawnRange = AerosConfig.spawnersSpawnRange;
		this.maxNearbyEntities = AerosConfig.spawnersMaxNearbyEntities;
		this.requiredPlayerRange = AerosConfig.spawnersRequiredPlayerRange;
		// Aeros end
	}
	...
	public void c() {
		...
		if (this.g()) {
			...
			if (this.a().isClientSide) {
				...
				// Aeros start - configurable spawner animations
				if (AerosConfig.spawnerAnimation) {
