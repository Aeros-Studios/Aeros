...
public class BlockPosition extends BaseBlockPosition {
	...
	public static Iterable<BlockPosition.MutableBlockPosition> b(BlockPosition blockposition,
			...
			public Iterator<BlockPosition.MutableBlockPosition> iterator() {
				return new AbstractIterator<BlockPosition.MutableBlockPosition>() {
					...
					protected BlockPosition.MutableBlockPosition computeNext() {
						if (this.b == null) {
							this.b = new BlockPosition.MutableBlockPosition(blockposition.getX(), blockposition.getY(),
									blockposition.getZ());
							return this.b;
						} else if (this.b.equals(blockposition1)) {
							return this.endOfData();
	...
	// Aeros start - obfuscation helper
	...
	public BlockPosition a(BaseBlockPosition baseblockposition) {
		return baseblockposition.getX() == 0 && baseblockposition.getY() == 0 && baseblockposition.getZ() == 0 ? this
				: new BlockPosition(this.getX() + baseblockposition.getX(), this.getY() + baseblockposition.getY(),
	...
	public BlockPosition up(int i) {
		return i == 0 ? this : new BlockPosition(this.getX(), this.getY() + i, this.getZ()); // Paper - Optimize
																								// BlockPosition
	}
	...
	public BlockPosition north(int i) {
		return i == 0 ? this : new BlockPosition(this.getX(), this.getY(), this.getZ() - i); // Paper - Optimize
																								// BlockPosition
	}
	...
	public BlockPosition west(int i) {
		return i == 0 ? this : new BlockPosition(this.getX() - i, this.getY(), this.getZ()); // Paper - Optimize
																								// BlockPosition
	}
	...
	public BlockPosition shift(EnumDirection enumdirection) {
		...
		case EAST:
			return new BlockPosition(this.getX() + 1, this.getY(), this.getZ());
		default:
			return new BlockPosition(this.getX() + enumdirection.getAdjacentX(),
					this.getY() + enumdirection.getAdjacentY(), this.getZ() + enumdirection.getAdjacentZ());
		}
		// Paper End
	}
	...
	public BlockPosition shift(EnumDirection enumdirection, int i) {
		...
		case EAST:
			return new BlockPosition(this.getX() + i, this.getY(), this.getZ());
		default:
			return new BlockPosition(this.getX() + enumdirection.getAdjacentX() * i,
					this.getY() + enumdirection.getAdjacentY() * i, this.getZ() + enumdirection.getAdjacentZ() * i);
		}
		// Paper End
	}

	public BlockPosition c(BaseBlockPosition baseblockposition) {
		return new BlockPosition(this.getY() * baseblockposition.getZ() - this.getZ() * baseblockposition.getY(),
	...
	public static final class MutableBlockPosition extends BlockPosition {
		...
		/*
		 * private int c; private int d; private int e;
		 */
		...
		/*
		 * public int getX() { return this.c; }
		 * 
		 * public int getY() { return this.d; }
		 * 
		 * public int getZ() { return this.e; }
		 */
