...
public class SpigotWorldConfig {
	...
	private void itemMerge() {
		// Aeros - optimize config defaults 2.5 -> 3.5
	...
	private void expMerge() {
		// Aeros - optimize config defaults 3.0 -> 4.0
	...
	private void mobSpawnRange() {
		// Aeros - optimize config defaults 4 -> 2
		mobSpawnRange = (byte) getInt("mob-spawn-range", 2);
		log("Mob Spawn Range: " + mobSpawnRange);
	}

	// Aeros - optimize config defaults 32 -> 16, 32 -> 24, 16 -> 8
	...
	private void nerfSpawnerMobs() {
		// Aeros - optimize config defaults false -> true
