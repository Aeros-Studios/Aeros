package dev.aeros.async.pathsearch;
...
import dev.aeros.async.pathsearch.cache.SearchCacheEntryEntity;
import dev.aeros.async.pathsearch.cache.SearchCacheEntryPosition;
...
public class SearchHandler {
	...
	private final ExecutorService executor = Executors.newFixedThreadPool(AerosConfig.pathSearchThreads,
			new ThreadFactoryBuilder().setNameFormat("Aeros Entity Path Search Thread %d").build());
