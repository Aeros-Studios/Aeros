...
public class MinecraftPipeline extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel channel) {
		try {
			...
			config.setOption(ChannelOption.TCP_NODELAY, AerosConfig.enableTCPNODELAY);
			config.setOption(ChannelOption.TCP_FASTOPEN, AerosConfig.modeTcpFastOpen);
			config.setOption(ChannelOption.TCP_FASTOPEN_CONNECT, AerosConfig.enableTcpFastOpen);
