...
public class KnockbackConfig {
	...
	private static final String HEADER = "This is the knockback configuration file for Aeros.\n"
			+ "For configuration info see this: https://github.com/Wind-Development/Aeros/wiki/Knockback-Configuration";
	...
	public static void init(File configFile) {
		...
		try {
			Aeros.LOGGER.info("Loading Aeros knockback config from " + configFile.getName());
		...
		if (!keys.contains("hypixel")) {
			...
			// https://www.spigotmc.org/resources/legacykb-disable-netherite-knockback-resistance.86080/
		...
		if (currentKb == null) {
			Aeros.LOGGER.warn("Knockback profile selected was not found, using profile 'kohi' for now!");
			currentKb = getKbProfileByName("kohi");

			Aeros.LOGGER.info("Setting default knockback as 'kohi'...");
